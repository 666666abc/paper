...
if __name__ == '__main__':
    ...
    parser.add_argument('--chemical_lr', type=float, default=0.01, help='Signature MLP learning rate')
    parser.add_argument('--scaling_lr', type=float, default=0.01, help='Scaling MLP learning rate')
    parser.add_argument('--translation_lr', type=float, default=0.01, help='Translation MLP learning rate')
    parser.add_argument('--lamda', type=float, default=0.005, help='task level adaptation learning rate')
